...
capture = cv2.VideoCapture(r'D:\git repos\NetCC\NetCC_-Image-recognition\python\gps.mp4')
...
#Perspective Point
point_list = []
point_list.append((1,296)) # Left Up
...
def tracking(tracker, num):
    ...
    while True:
      ...
      for i in range(int(compare_size)):
          k=0
          for j in range(int(trc_size)):
              x=compare[2*i][0]
              y=compare[2*i][1]
