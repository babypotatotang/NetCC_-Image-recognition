...
# Perspective Point
point_list = []
point_list.append((499, 180))  # Left Up
point_list.append((757, 199))  # Right Up
point_list.append((123, 425))  # Left Down
point_list.append((981, 582))  # Right Down
...
def tracking(tracker, num, index):
    ...
    '''
        ...
        h_pt=(int(left + (right - left) / 2), bottom)
