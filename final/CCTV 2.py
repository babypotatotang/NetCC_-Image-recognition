...
point_list.append((360, 164))
point_list.append((564, 159))
point_list.append((144, 400))
point_list.append((794, 388))
...
def gps_conversion(foot_x, foot_y):
    ...
    equation2 = (-(gps_list[0][1]-gps_list[1][1])/(gps_list[0][0]-gps_list[1][0]))*(x-res[0][a])+res[0][b]-y
    res=solve((equation1, equation2), dict=True)
    gps = str(res[1][y])+' '+str(res[1][x])+' '
    return gps
